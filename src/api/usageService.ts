...
export const usageService = {
  getStats: async (userAddress: string): Promise<UsageStats> => {
    const response = await axios.get(
      `${API_URL}/api/usage/stats/${userAddress}`,
    );
  ...
  getHistory: async (
    ...
    const response = await axios.get(
      `${API_URL}/api/usage/history/${userAddress}`,
      {
        params: { limit, offset },
      },
    );
  ...
  getChartData: async (
    ...
    const response = await axios.get(
      `${API_URL}/api/usage/chart/${userAddress}`,
      {
        params: { timeframe },
      },
    );
  ...
  getModels: async (searchQuery?: string): Promise<any[]> => {
    try {
      ...
      console.error(
        "Failed to fetch agent models, falling back to usage API",
        err,
      );
      const params: any = {};
  ...
  getModelsByProvider: async (provider: string): Promise<any[]> => {
    try {
      const response = await axios.get(
        `${API_URL}/api/agent/models/provider/${provider}`,
      );
  ...
  getLastUsedModels: async (
    userAddress: string,
    timeframe = "all",
  ): Promise<any[]> => {
    const response = await axios.get(
      `${API_URL}/api/usage/last-used/${userAddress}`,
      {
        params: { timeframe },
      },
    );
  ...
  getEnabledModels: async (userAddress: string): Promise<string[]> => {
    const response = await axios.get(
      `${API_URL}/api/usage/models/enabled/${userAddress}`,
    );
    return response.data;
  },
  ...
  saveEnabledModels: async (
    ...
    await axios.post(`${API_URL}/api/usage/models/enabled/${userAddress}`, {
      models,
    });
  },
  ...
  getDefaultEnabledModels: async (): Promise<string[]> => {
    const response = await axios.get(
      `${API_URL}/api/usage/models/enabled/default`,
    );
    return response.data;
  },
  ...
  getEnabledAgents: async (userAddress: string): Promise<string[]> => {
    const response = await axios.get(
      `${API_URL}/api/usage/agents/enabled/${userAddress}`,
    );
    return response.data;
  },

  saveEnabledAgents: async (
    userAddress: string,
    agents: string[],
  ): Promise<void> => {
    await axios.post(`${API_URL}/api/usage/agents/enabled/${userAddress}`, {
      agents,
    });
  },
  ...
  getDefaultEnabledAgents: async (): Promise<string[]> => {
    const response = await axios.get(
      `${API_URL}/api/usage/agents/enabled/default`,
    );
    return response.data;
  },
};
