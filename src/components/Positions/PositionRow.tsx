      ...
      <tr className={`${styles.row} ${styles.desktopRow}`}>
        ...
        <td className={`${styles.td} ${styles.tdRight}`}>
          <span style={{ color: "#FFFFFF" }}>
            {formatCrypto(position.size)}{" "}
            <span style={{ color: "#A77590", fontSize: "11px" }}>
              {position.symbol}
            </span>
          </span>
        </td>
        ...
        <td className={`${styles.td} ${styles.tdRight}`}>
          <span style={{ color: "#FFFFFF" }}>
            ...
            <span style={{ color: "#A77590", fontSize: "11px" }}>USDC</span>
          </span>
        </td>
        ...
        <td className={`${styles.td} ${styles.tdRight}`}>
          <span>
            ...
            <span style={{ color: "#A77590", fontSize: "11px" }}>(Cross)</span>
          </span>
        </td>
        ...
        <td className={styles.td}>
          <div className={styles.actionGroup}>
            <button className={styles.actionButton} onClick={handleLimitClick}>
              Limit
            </button>
            <button className={styles.actionButton} onClick={handleMarketClick}>
              Market
            </button>
            <button
            ...
            <div className={styles.mobileHeader} onClick={toggleExpand}>
              <div className={styles.mobileHeaderContent}>
                ...
                >
                  ...
                  <span style={{ color: "#00E396", fontSize: "13px" }}>
                ...
                >
                  ...
                  >
                    <span className={pnlColor} style={{ fontSize: "13px" }}>
                      {pnlText}
                    </span>
                    <span
                      className={
            ...
            {isExpanded && (
              <div className={styles.mobileDetails}>
                ...
                <div className={styles.mobileDetailRow}>
                  ...
                  <span className={styles.mobileValue}>
                    {formatUsd(position.sizeUsd)} USDC
                  </span>
                </div>
                <div className={styles.mobileDetailRow}>
                  <span className={styles.mobileLabel}>Margin</span>
                  <span className={styles.mobileValue}>
                    ${formatUsd(position.margin)} (Cross)
                  </span>
                </div>
                <div className={styles.mobileDetailRow}>
