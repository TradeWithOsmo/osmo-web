    ...
    return (
        <React.Fragment>
            ...
            <tr className={`${panelStyles.row} ${panelStyles.desktopRow}`}>
                ...
                {showModelColumn && (
                    <td className={panelStyles.td} style={{ color: '#A77590', width: '150px' }}>
                        {item.agentModel || 'N/A'}
                    </td>
                )}
                        ...
                        <div className={panelStyles.mobileHeader} onClick={toggleExpand}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', alignItems: 'flex-end' }}>
                                    ...
                                    <span style={{ color: item.roi >= 0 ? '#00E396' : '#FF4560', fontSize: '13px' }}>
                                        {item.roi >= 0 ? '+' : ''}{item.roi.toFixed(2)}%
                                    </span>
                                </div>
                        ...
                        {isExpanded && (
                            <div className={panelStyles.mobileDetails}>
                                ...
                                <div className={panelStyles.mobileDetailRow}>
                                    ...
                                    <span className={panelStyles.mobileValue} style={{ color: '#FFE1F2' }}>
                                        {item.tradeCount} / <span style={{ color: '#00E396' }}>{item.winRate.toFixed(1)}%</span>
                                    </span>
                                </div>
                                <div className={panelStyles.mobileDetailRow}>
